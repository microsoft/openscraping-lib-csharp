...
RemoveExtraSpacesTransformation          | Replaces consecutive spaces with a single space. For the string "hello     world" it would return "hello world" | [Here](https://github.com/Microsoft/openscraping-lib-csharp/blob/master/OpenScraping.Tests/stackexchange.com.json)
SplitTransformation                      | Splits the string into an array based on a separator. | [Here](https://github.com/Microsoft/openscraping-lib-csharp/blob/master/OpenScraping.Tests/support.office.com.json)
